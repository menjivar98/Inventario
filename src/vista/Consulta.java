    ...
    public void eventos() {
        insertar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (fd.create(f)) {
                    JOptionPane.showConfirmDialog(null, "Filtro registrado con exito");
                    limpiarCampos();
                    llenarTabla();
                } else {
                    JOptionPane.showMessageDialog(null, "Ocurrio un pronlema al momento de crear el filtro");
                }
            }
        });
        ...
        eliminar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (fd.delete(codigo.getText())) {
                    ...
                    JOptionPane.showMessageDialog(null, "Ocurrio un problema al momento de eliminar");
                }
            }
        });
